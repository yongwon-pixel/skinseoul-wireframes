...
- When: click the ✕ button (`button.scandel`, title "Delete scan row") on row #3 (tracking YT2618100700000005, verdict pill `.cs-dup` text "⚠ Duplicate scan")
- Then: overlay `#m-scandel` gains class `open`; header text = "Delete Scan Row"; body bold text = "Remove this scan?"; `#scandelInfo` text = "#3 · YT2618100700000005"; note text contains "Deletion history is kept in the backend."
...
- And: the row for tracking YT2618100700000006 has class `row-bad` and verdict pill `.cs-processing` with text "⚠ Not outbounded"; Notes cell contains button "Process this order"
