...
10. **Decision Log** — 2026-07-14 real-capture rework (commit 9844fe0, Order #400001); 2026-07-21 full capture + double-click bug moved to handoff notes (not annotated in wireframe); 2026-07-22 Hold state view added; 2026-07-23 Latest Inventory Count restored / Delivery Company+Comments columns removed; 2026-08-03 English pass (90 replacements), global toast rule, instant print reconfirmation, comments channel confirmed, "Request Inbound" retired, Print label de-suffixed, Outbound relabel + gate.
