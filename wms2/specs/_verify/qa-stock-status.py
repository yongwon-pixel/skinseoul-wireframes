...
def qa_his_06(page):
    ...
    good = (d["nPending"] == 1 and c[0] == "INBOUND" and c[1] == "+6" and c[2] == "PENDING"
            and c[3] == "12101316464794" and c[4] == "Coupang" and c[6] == "400001" and c[8] == "Miranti"
...
def qa_com_01(page):
    ...
    good = ("💬 Comments" in d0["btn"] and d0["badge"] == "3" and d["open"]
            and d["tabOn"].startswith("@ Mentions") and d["unread"] == ["409112", "400001", "407506"])
...
def qa_com_02(page):
    ...
    good = (d["mDisp"] == "none" and d["sDisp"] != "none" and d["n"] == 1 and d["order"] == "400001"
...
def qa_com_03(page):
    ...
    a2 = js(page, """() => [...document.querySelectorAll('#inbox1 [data-pane=mentions] .it')]
        .find(i=>i.innerText.includes('409112')).querySelector('.star').classList.contains('on')""")
    good = d0 == [["409112", False], ["400001", True], ["407506", False]] and a1 and not a2
