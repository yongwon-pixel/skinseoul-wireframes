...
| `QA-SUB-2` | **PASS** | h2='Order # 400001' carrier='YUN' buttons=['View Label', '🖨 Print', 'Change Status ▾'] |
...
| `QA-SUB-5` | **PASS** | headings=[{'h': '📋 Order Information', 'edit': None}, {'h': '👤 Billing Address ✎', 'edit': '✎'}, {'h': '🚚 Shipping Address ✎', 'edit': '✎'}] TaxID='–' ShortAddr='–' Email='jane.doe@example.com' |
...
| `QA-EDIT-4` | **PASS** | cells=['0', 'INBOUNDED', 'JIT (Coupang)', '12101316464794', '2026-06-30', '₩17,100', '10323100000001', 'coupang…7923'] inputs=0 |
...
| `QA-HUB-6` | **PASS** | sachet: '1 results · newest first · click to open the order' ['Order 407688 · Aldo: "Customer note checked — sachet included" Yesterday 09:40'] marks=['sachet']; dean: '2 results · newest first · click to open the order' order=['Order 400001 · Dean: "', 'Order 407301 · Dean: "'] |
