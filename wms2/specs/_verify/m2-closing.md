...
| 5 | QA-SCAN-01 | PASS | 5 | placeholder + `value="YT2618100700000004"` + sibling `button.btn-blue` `"Scan"` + not `disabled` |
...
| 10 | QA-VERDICT-02 | PASS | 5 | `.okline b` = `"✓ #5 Outbounded"`; contains `"Order 413540 · Tracking YT2618100700000004 · Prepare Shipment"`; `.mut` = `"18:41:07 · Dean"`; `#s1 .bigstatus` = 0 |
...
| 46 | QA-DEL-10 | PASS | 2 | wf-bar tab opens `#m-scandel`; `#scandelInfo` default `"#7 · YT2618100700000007"` |
...
| 68 | QA-CHROME-06 | PASS | 3 | at 1440×900 `body.scrollWidth (1440) <= body.clientWidth (1440)`; all 10 `th` rendered, none `display:none`; `"YT2618100700000005"` present, no `…` anywhere in the tracking column |
