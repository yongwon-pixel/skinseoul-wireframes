...
def his06(page):
    ...
    check(c[0] == "INBOUND" and c[1] == "+6" and c[3] == "12101316464794" and c[4] == "Coupang"
          and c[6] == "400001" and c[8] == "Miranti",
          "pending row = INBOUND +6, tracking 12101316464794, Coupang, 400001, Miranti", c)
...
def com01(page):
    ...
    check(r["its"] == ["Order 409112", "Order 400001", "Order 407506"],
          "exactly three .it.unread for 409112/400001/407506", r["its"])
...
def com02(page):
    ...
    check(r["entries"] == ["Order 400001"], "exactly one saved entry (Order 400001)", r["entries"])
...
def com03(page):
    ...
    check(r0 == [{"o": "Order 409112", "on": False}, {"o": "Order 400001", "on": True}, {"o": "Order 407506", "on": False}],
          "400001 star on; 409112/407506 stars off", r0)
