...
def qa_map(d):
    ...
    c = (h1 == 'WMS 2.0 · Order Detail Wireframe'
         and hint == 'v1 — Based on the live admin (Order #400001) · Purple numbers = new/changed annotations'
...
def qa_ren(d):
    ...
    c = (thd == ['Provider Order ID', 'Tracking Number', 'Status', 'Status Description', 'Created At', 'Updated At']
         and row == ['YT2618100700000001', '34YEM000000000000000001', 'DELIVERED', 'Shipment information received',
    ...
    c = lt == '10323100000001' and ft == '34YEM000000000000000001' and 'Tracking Number' in hdr_li
...
def qa_sub(d):
    ...
    c = h2 == 'Order # 400001' and seq['status'] and seq['carrier'] == 'YUN' and \
    ...
    c = (any(e['h'].startswith('👤 Billing Address') and e['edit'] == '✎' for e in edits)
         ...
         and kv.get('Email') == 'jane.doe@example.com' and kv.get('Phone') == '+61400000001')
...
def qa_group4(d):
    ...
    want = ['0', 'INBOUNDED', 'JIT (Coupang)', '12101316464794', '2026-06-30', '₩17,100', '10323100000001', 'coupang…7923']
...
def qa_hub(d):
    ...
    c = (h1 == '1 results · newest first · click to open the order' and len(i1) == 1
         ...
         and 'Order 400001' in i2[0] and 'Order 407301' in i2[1])
